    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4">
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-border flex-shrink-0">
          <h3 className="text-base font-semibold text-text-primary">Edit Test creation</h3>
                          ...
                          {OPTION_KEYS.filter((key) => !!q[key]?.trim()).map((key, i) => {
                            ...
                            return (
                              <div key={key} className={`flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm ${
                                isCorrect ? 'bg-badge-green-bg text-badge-green-text font-medium' : 'bg-gray-50 dark:bg-gray-700 text-text-primary'
                              }`}>
